...
export default function Footer() {
  const { isDevMode, toggleDevMode } = useThemeManagerContext();
        ...
        <div>
          <label className="relative inline-flex items-center cursor-pointer leading-none align-middle">
            <input
              ...
              aria-label="Toggle Normal / Dev Mode"
            />
            ...
            {/* Icono Normal (representado por Sol) */}
            <Sun
              aria-hidden
            ...
            {/* Icono Dev (representado por Luna para mantener estética) */}
            <Moon
              aria-hidden
